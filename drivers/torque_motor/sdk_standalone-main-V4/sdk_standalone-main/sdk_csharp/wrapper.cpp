...
void Axis::SetDirOutput(int index)
{
	return safe_call(((RMAxis*)this->ctx), &RMAxis::set_dir_output, index);
}
int Axis::GetDirInput()
{
	return safe_call(((RMAxis*)this->ctx), &RMAxis::get_dir_input);
}
void Axis::GoHome()
{
