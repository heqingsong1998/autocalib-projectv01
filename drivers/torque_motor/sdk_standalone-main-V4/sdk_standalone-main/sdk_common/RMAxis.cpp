...
void RMAxis::set_dir_output(int index)
{
	this->set_parameter<int>("hardware_direct_output", index);

}

int RMAxis::get_dir_input()
{
	return this->get_parameter<int>("hardware_direct_input");
